...
void changeColor();
unsigned int detectKeyPress1();
unsigned int detectKeyPress2();
...
unsigned int detectKeyPressboth(){

	unsigned int retFlag = false;
	uint8_t value1 = GPIOPinRead(GPIO_PORTF_BASE,GPIO_PIN_0);
	uint8_t value2 = GPIOPinRead(GPIO_PORTF_BASE,GPIO_PIN_4);
	return retFlag;
