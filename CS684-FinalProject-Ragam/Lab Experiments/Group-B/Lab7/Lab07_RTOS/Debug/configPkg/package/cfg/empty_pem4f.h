...
extern const ti_sysbios_knl_Task_Handle readADChandle;

#include <ti/sysbios/knl/Task.h>
extern const ti_sysbios_knl_Task_Handle readSwitchhandle;

#include <ti/sysbios/knl/Task.h>
extern const ti_sysbios_knl_Task_Handle updateGLCDhandle;
