...
void setup(void){
	SysCtlClockSet(SYSCTL_SYSDIV_5|SYSCTL_USE_PLL|SYSCTL_XTAL_16MHZ|SYSCTL_OSC_MAIN); //Clock at 40MHz
	SysCtlPWMClockSet(SYSCTL_PWMDIV_64); //Runs PWN Clock at 625kHz
