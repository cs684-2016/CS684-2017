...
linker.cmd: package/cfg/empty_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/empty_pem4fcfg.cmd\)\"$""\"/home/diptesh/ccs_workspace/empty_EK_TM4C123GXL_TI_TivaTM4C123GH6PM/.config/xconfig_empty/\1\""' package/cfg/empty_pem4f.xdl > $@
