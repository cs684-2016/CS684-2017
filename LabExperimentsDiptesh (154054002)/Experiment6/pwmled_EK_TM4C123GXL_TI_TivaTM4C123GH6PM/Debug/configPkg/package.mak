...
.dlls,em4f .dlls: pwmled.pem4f

-include package/cfg/pwmled_pem4f.mak
-include package/cfg/pwmled_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/pwmled_pem4f.dep
endif
pwmled.pem4f: package/cfg/pwmled_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
pwmled.pem4f package/cfg/pwmled_pem4f.c: .libraries,em4f
endif

package/cfg/pwmled_pem4f.c package/cfg/pwmled_pem4f.h package/cfg/pwmled_pem4f.xdl: override _PROG_NAME := pwmled.xem4f
package/cfg/pwmled_pem4f.c: package/cfg/pwmled_pem4f.cfg
package/cfg/pwmled_pem4f.xdc.inc: package/cfg/pwmled_pem4f.xdl
package/cfg/pwmled_pem4f.xdl package/cfg/pwmled_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/pwmled_pem4f.cfg
	-$(RM) package/cfg/pwmled_pem4f.dep
	-$(RM) package/cfg/pwmled_pem4f.c
	-$(RM) package/cfg/pwmled_pem4f.xdc.inc

clean,em4f::
	-$(RM) pwmled.pem4f
.executables,em4f .executables: pwmled.xem4f

pwmled.xem4f: |pwmled.pem4f

-include package/cfg/pwmled.xem4f.mak
pwmled.xem4f: package/cfg/pwmled_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@) -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/pwmled_pem4f.oem4f   package/cfg/pwmled_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
pwmled.xem4f: export C_DIR=
pwmled.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/:$(PATH)

pwmled.test test,em4f test: pwmled.xem4f.test

pwmled.xem4f.test:: pwmled.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 pwmled.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.pwmled.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,pwmled.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
pwmled_pem4f.oem4f,copy : package/cfg/pwmled_pem4f.oem4f
pwmled_pem4f.sem4f,copy : package/cfg/pwmled_pem4f.sem4f
